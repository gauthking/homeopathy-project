      ...
      <section className="grid p-4 sm:p-auto md:grid-cols-2 px-10 gap-10">
        ...
        <div className="flex flex-col justify-center gap-y-2">
          ...
          <p className=" text-lg text-justify  text-neutral-800 max-w-[600px]">
            Joy Homeo Clinic in Perambur is a top player in the category
            Homeopathic Clinics in Chennai. This well-known establishment acts
            as an one-stop destination servicing customers both local and from
            other parts of Chennai. Over the course of its journey, this
            business has established a firm foothold in it’s industry. The
            ...
            Chennai, this establishment occupies a prominent location in
            Perambur. It is an effortless task in commuting to this
            establishment as there are various modes of transport readily
            available. It is at Bunder Garden 2nd Street , Near Subiksha Nursing
            Home, which makes it easy for first-time visitors in locating this
            establishment.
          </p>
